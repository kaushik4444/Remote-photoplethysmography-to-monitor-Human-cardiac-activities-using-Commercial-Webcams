          ...
          if frame_count % int(fps) == 0:
              ...
              if is_update:
                  if second == 3:
                      ...
                      blue.append(b_plot[len(b_plot) - int(fps):len(b_plot) - 1])
                      green.append(g_plot[len(g_plot) - int(fps):len(g_plot) - 1])
                      red.append(r_plot[len(r_plot) - int(fps):len(r_plot) - 1])
                      fr.append(f_plot[len(f_plot) - int(fps):len(f_plot) - 1])

                  del b_plot[0:int(fps)]
                  del g_plot[0:int(fps)]
                  del r_plot[0:int(fps)]
                  del f_plot[0:int(fps)]
